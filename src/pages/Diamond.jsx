...
const Diamond = () => {
  ...
  return (
    <section className="bg-[#f5f5ff] min-h-screen">
      ...
      <div className="h-[60vh] flex">
        ...
        <div className="w-1/2 bg-[#122B4B] flex items-center px-16">
          <div>
            ...
            <p className="mt-6 text-gray-200 text-lg leading-7 max-w-md">
              Explore dazzling diamond jewellery crafted for elegance and luxury.
            </p>
          </div>
        </div>
