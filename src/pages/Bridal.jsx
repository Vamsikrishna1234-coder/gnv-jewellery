// src/pages/Bridal.jsx

import React, { useState, useEffect } from "react";
import ProductCard from "../components/Cards/ProductCard";
import bridalProducts from "../data/bridalProducts";
import bg1 from "../assets/images/bridal bg1.jpg";
...
const Bridal = () => {
  ...
  const [filteredProducts, setFilteredProducts] = useState(bridalProducts);
      ...
      <div className="h-[60vh] flex">
        ...
        <div className="w-1/2 bg-black flex items-center px-16">
          <div>
            ...
            <p className="mt-6 text-pink-100 text-lg leading-7 max-w-md">
              Discover luxurious bridal jewellery crafted for your special day.
            </p>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
          ...
          <div className="bg-white p-8 rounded-2xl w-[420px] relative">
            ...
            >
              ...
              <option value="haaram">Haaram</option>
            </select>
