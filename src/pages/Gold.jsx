...
import bg1 from "../assets/images/gold bg1.png";
  ...
  return (
    <section className="bg-[#fff8dc] min-h-screen">
      ...
      <div className="h-[60vh] flex">
        ...
        <div className="w-1/2 bg-[#c28b00] flex items-center px-16">
          <div>
            ...
            <p className="mt-6 text-[#e8d5b8] text-lg leading-7 max-w-md">
              Explore premium gold jewellery crafted with elegance and purity.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-14">
        ...
        <div className="relative mb-8 ">
          ...
          {/* RIGHT */}
          <div className="absolute right-0 top-1/2 -translate-y-1/2 flex gap-2 items-center text-sm">
          ...
          <div className="bg-white p-8 rounded-2xl w-[420px] relative">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="flex-1 bg-[#2c1f14] text-white py-3 rounded-lg"
              >
                Apply Filter
              </button>
